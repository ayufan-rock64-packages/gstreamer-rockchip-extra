...
G_BEGIN_DECLS
#define GST_TYPE_RGA_CONVERT \
  (gst_rga_convert_get_type())
#define GST_RGA_CONVERT(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_RGA_CONVERT,GstRGAConvert))
#define GST_RGA_CONVERT_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_RGA_CONVERT,GstRGAConvertClass))
...
#define GST_RGA_CONVERT_GET_CLASS(inst) \
  (G_TYPE_INSTANCE_GET_CLASS ((inst),GST_TYPE_RGA_CONVERT,GstRGAConvertClass))
